...
export default class Game extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        setting.on('pointerdown', () => {
            this.registry.set('Thisgame_score', parseInt(this.score.text));
            this.scene.setActive(false,"game");
        ...
        // timer
        this.total_time=6000*(3-parseInt((this.game_level-0.1)/5));  //in millisecond
        ...
        if (this.game_level<15){
            ...
            if(parseInt(this.score.text)>=this.game_level*10){
                ...
                fetch('http://3.96.64.25:9090/fisherman/GPT/updateScoreAndTime', {
                    ...
                    body: JSON.stringify({
                        id: userid,
                        score: parseInt(this.score.text),
                    }),
                })
